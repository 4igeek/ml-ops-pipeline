...
Once you have completed all of the steps outlined in my blog post then take a look at the [End-To-End MLOps Pipeline](https://github.com/4igeek/ml-ops-pipeline/blob/main/program/main.ipynb) (`Program>main.ipynb`)