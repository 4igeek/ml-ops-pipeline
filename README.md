...
This project was created using Windows 11. You will also need to install [Windows Subsystem for Linux](https://learn.microsoft.com/en-us/windows/wsl/install) to get it to work. This is real easy to do, just run `wsl --install` in your terminal and you'll be good to go.
